...
const AddRcsTestNumberSchema = {
  ...
  testNumbers: z
    ...
    .describe(
      'Phone numbers for testing, added in a single request (max 20). An agent can send 20 tester requests per day, ' +
        'with a total maximum of 200 tester requests per sender.',
    ),
};
