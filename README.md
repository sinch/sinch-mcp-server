...
- Conversation API credentials:
  ...
  - `NGROK_AUTH_TOKEN`: Used for the tool to get the webhook event from the Sinch platform. You can get it from your [ngrok dashboard](https://dashboard.ngrok.com/get-started/your-authtoken). If you don't set it, the MCP server will not receive the webhook events.
