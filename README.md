...
| **create-conversation-app**           | Create a new Conversation API app (no channels required at creation). <br> *Example prompt*: "Create a Conversation app named My Support Bot in the EU region."                                                                       | conversation, notification |
| **add-sms-channel-to-app**            | Add or update the SMS channel on a Conversation app. <br> *Example prompt*: "Add SMS to app abc123 using service plan XYZ and API token …"                                                                                            | conversation, notification |
| **add-rcs-channel-to-app**            | Add or update the RCS channel on a Conversation app. <br> *Example prompt*: "Configure RCS on app abc123 with sender ID … and bearer token …"                                                                                         | conversation, notification |
| **add-whatsapp-channel-to-app**       | Add or update the WhatsApp channel on a Conversation app. <br> *Example prompt*: "Add WhatsApp to app abc123 with sender ID … and bearer token …"                                                                                   | conversation, notification |
