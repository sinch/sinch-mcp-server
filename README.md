...
| **list-webhooks**                     | List webhooks configured for a Conversation app. <br> *Example prompt*: "List all webhooks for my Conversation app."                                                                                                                | conversation, notification |
| **get-webhook**                       | Get a webhook by ID. <br> *Example prompt*: "Show me the details of webhook ID abc123."                                                                                                                                             | conversation, notification |
| **create-webhook**                    | Create a webhook that delivers Conversation API events to a target URL. <br> *Example prompt*: "Create a webhook for inbound messages at https://example.com/callback."                                                             | conversation, notification |
| **update-webhook**                    | Update a webhook target URL and/or triggers. <br> *Example prompt*: "Update webhook abc123 to also receive MESSAGE_DELIVERY events."                                                                                                | conversation, notification |
| **delete-webhook**                    | Delete a webhook by ID. <br> *Example prompt*: "Delete webhook abc123."                                                                                                                                                             | conversation, notification |
