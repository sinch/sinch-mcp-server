...
export const registerSendTextMessage = (server: McpServer) => {
  server.tool(
    'send-text-message',
    'Send a text message to a contact on the specified channel. The contact can be a contact ID, a phone number for the SMS or RCS channel, or a name to associate with a contact in the address book.',
    {
      contact: z.string().describe('The contact to send the text message to. This can be a contact ID, a phone number in E.164 format, or a name to associate with a contact in the address book.'),
